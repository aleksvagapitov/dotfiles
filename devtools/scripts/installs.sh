...
sed -i "/127.0.0.1/ a 172.17.0.1 dev.tools" /etc/hosts
sed -i "/127.0.0.1/ a 172.17.0.1 teamcity.dev.tools" /etc/hosts
sed -i "/127.0.0.1/ a 172.17.0.1 registry.dev.tools" /etc/hosts
